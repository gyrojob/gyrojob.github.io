...
document.write("<iframe  frameborder='0' scrolling='no' width='"+gyro_ads_width+"%'  style='background:;'     height='"+gyro_ads_height+"px'      src='//jobs.gyrojob.com/d.html?h="+gyro_ads_height+"&adid="+gyro_ads_adid+"&adno="+gyro_ads_no+"&border="+gyro_ads_border+"&bg="+gyro_ads_bg+"&w="+gyro_ads_width+"' style='padding:0px;margin:0px;'></iframe>");var ht = window.location.protocol;var pathname = window.location.hostname;document.getElementById('msg').innerHTML = ht+"//"+pathname;