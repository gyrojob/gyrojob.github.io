...
document.write("<iframe  frameborder='0' scrolling='no' width='235'  style='background:;'     height='305px'      src='//jobs.gyrojob.com/display.php?adid="+gyro_ads_adid+"&adno="+gyro_ads_no+"&border="+gyro_ads_border+"&bg="+gyro_ads_bg+"&ex1="+gyro_ads_ex1+"' style='padding:0px;margin:0px;'></iframe>");var ht = window.location.protocol;var pathname = window.location.hostname;document.getElementById('msg').innerHTML = ht+"//"+pathname;